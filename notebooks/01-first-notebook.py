...
def _(freight_charges):
    ...
    for freight_2 in freight_charges:
        if freight_2 <= 25:
            below_or_equal_25.append(freight_2)
...
app._unparsable_cell(
    r"""
    import pandsa
    The last line gives a ModuleNotFoundError. This means Python tried to find the package called pandsa, but it does not exist because the package name is misspelled.
    """,
    name="_"
)
...
app._unparsable_cell(
    ...
    The last line gives a FileNotFoundError. This means Python tried to open sales.csv, but it could not find that file in the location where it was looking.
    """,
    name="_"
)
...
app._unparsable_cell(
    ...
    The error is a SyntaxError. This means Python cannot understand the code because the list was opened with [ but was never closed with ].
    """,
    name="_"
)
...
app._unparsable_cell(
    r"""
    # Python names line 3 total = sum(freight_charges)
    I would change line 1 because line 3 is where python encounters the error
    I would change line 1 to freight_charges = [16.75, 22.25, 0, 9.50]
    """,
    name="_"
)
